...
define([
    ...
    return Component.extend({
        defaults: {
            template: "MoneyHash_CustomPayment/payment/custompayment",
            cardElementsMap: {
                "card-holder-name": {
        ...
        displayPaymentMethods: async function () {
            try {
                ...
                console.log(expressMethods, paymentMethods);
        ...
        renderCardFormErrors: function (errors) {
            Object.keys(cardElementsMap).forEach((field) => {
                const errorElement = document.getElementById(`${field}-error`);
                const fieldValidationKey = cardElementsMap[field].validationKey;
